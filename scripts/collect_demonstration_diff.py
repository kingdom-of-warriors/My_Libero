...
if __name__ == "__main__":
    ...
    print("problem_name, domain_name, language_instruction",problem_name, domain_name, language_instruction)
    ...
    if args.device == "keyboard":
        ...
        device = Xbox(pos_sensitivity=args.pos_sensitivity, rot_sensitivity=args.rot_sensitivity, main_device=True)
        
    else: raise Exception("Invalid device choice: choose either 'keyboard' or 'spacemouse' or 'xbox'.")
