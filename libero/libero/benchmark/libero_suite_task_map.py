libero_task_map = {
    "lift_and_place": [
        "pick_the_alphabet_soup_and_place_it_in_the_basket",
        "pick_the_bbq_sauce_and_place_it_in_the_basket",
        "pick_the_butter_and_place_it_in_the_basket",
        "flip_the_basket_upside_down",
    ],
    "libero_spatial": [
